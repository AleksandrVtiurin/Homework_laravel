...
class StudentController extends Controller
{
    ...
    public function update(Request $request, Group $group, Student $student)
    {
        ...
        return redirect()->route('groups.show', $group)->with('success', 'Студент успешно обновлён');
    }
    ...
    {
        $student->delete();
        return redirect()->route('groups.show', $group)->with('success', 'Студент успешно удалён');
    }
}