...
Описание реализованного функционала авторизации
В рамках технического задания был развернут проект на Laravel с установленным пакетом Laravel UI для аутентификации, а также создан защищенный контроллер, отображающий данные авторизованного пользователя (ID, имя, email).
Шаги реализации:
Установил пакет Laravel UI через Composer
Установил Bootstrap scaffolding с аутентификацией
Установил и скомпилировал npm зависимости
Настроил базу данных SQLite и выполнил миграции
Создал контроллер
Добавил в контроллер middleware auth и метод, возвращающий ID, имя и email пользователя
Создал файл представления resources/views/profile.blade.php для отображения данных
Добавил маршрут в routes/web.php
